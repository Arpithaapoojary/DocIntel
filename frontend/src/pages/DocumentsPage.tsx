    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200 pb-5 dark:border-slate-800">
        ...
        <div className="flex items-center gap-2">
          <div className="rounded-lg border border-slate-200 bg-white px-3 py-1.5 dark:border-slate-800 dark:bg-slate-900 shadow-xs">
            <span className="font-mono text-[10px] uppercase text-slate-500">Storage</span>
            <p className="font-mono text-xs font-semibold text-slate-900 dark:text-slate-100">{formatBytes(totalStorage)}</p>
          </div>
          <div className="rounded-lg border border-slate-200 bg-white px-3 py-1.5 dark:border-slate-800 dark:bg-slate-900 shadow-xs">
            <span className="font-mono text-[10px] uppercase text-slate-500">Chunks</span>
            <p className="font-mono text-xs font-semibold text-brand-600 dark:text-brand-400">{totalChunks}</p>
          </div>
        </div>
      </div>
      ...
      <div
        ...
        className={`flex flex-col items-center justify-center gap-2.5 rounded-xl border-2 border-dashed px-6 py-8 text-center cursor-pointer transition-colors ${
          dragOver
      ...
      >
        <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 text-slate-600 dark:border-slate-800 dark:bg-slate-800 dark:text-slate-300">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        <div className="relative flex-1 sm:max-w-xs">
          ...
          <input
            ...
            className="h-9 w-full rounded-lg border border-slate-200 bg-white pl-8 pr-3 font-sans text-xs text-slate-900 placeholder:text-slate-400 focus:border-brand-600 focus:outline-none focus:ring-1 focus:ring-brand-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100 shadow-xs"
          />
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="h-9 rounded-lg border border-slate-200 bg-white px-2.5 font-sans text-xs text-slate-700 focus:border-brand-600 focus:outline-none dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 shadow-xs cursor-pointer"
          >
                  ...
                  >
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md border border-slate-200 bg-slate-50 text-slate-500 dark:border-slate-800 dark:bg-slate-800 dark:text-slate-400">
                          {doc.status === 'ready' ? (
